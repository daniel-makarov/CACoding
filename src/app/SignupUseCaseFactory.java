...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearUserDataAccessInterface clearUserDataAccessInterface = (ClearUserDataAccessInterface) userDataAccessObject;
            ClearController clearController = createClearUseCase(clearViewModel, clearUserDataAccessInterface);
